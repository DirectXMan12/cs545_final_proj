...
template class TomoImage<unsigned char>; // to get the compiler to play nicely with template classes in headers, etc
template class TomoImage<float>; // to get the compiler to play nicely with template classes in headers, etc
template class TomoImage<int>; // to get the compiler to play nicely with template classes in headers, etc
